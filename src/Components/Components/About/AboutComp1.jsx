    ...
    return(
        <div className="about-comp1">
            ...
            <div className="comp1-content">
                ...
                <div className="comp1-line"><svg width="249" height="3" viewBox="0 0 249 3" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.05933 1.31783H246.791" stroke="#E2E4E8" stroke-width="2.53102" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="0 9.28"/>
                    </svg>
                </div>
                <div className="comp1-desc">
                    ...
                    <p>Qareluv was Upload<span>Modern House!</span></p>
                </div>
            </div>
        </div>
    )
