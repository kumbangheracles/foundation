    ...
    return(
        <form action="" className="about-email-input">
            <div className="input-email">
                <svg style={{display: focus ? 'none' : 'block'}}  width="27" height="20" viewBox="0 0 27 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <input onChange={()=> setFocus(true)} onBlur={()=> setFocus(false)} type="text" name="email" id="email" placeholder="Enter your email"/>
            </div>
